<script setup>
import profileBlank from '@/../assets/img/blank-profile.png';
            ...
            <ul class="navbar-nav navbar-align">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
                        ...
                        <div class="list-group">
                            <a href="#" class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col-2">
                                        <img :src="profileBlank" class="avatar img-fluid rounded-circle"
                                            alt="Vanessa Tucker">
                                    </div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-icon pe-md-0 dropdown-toggle" href="#" data-bs-toggle="dropdown">
                        <img :src="profileBlank" class="avatar img-fluid rounded" alt="Charles Hall" />
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <form @submit.prevent="submit">
                            <button type="submit" class="dropdown-item" @click.prevent="logout">Log out</button>
                        </form>
                    </div>
                </li>
            </ul>
